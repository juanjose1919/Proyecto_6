...
st.markdown(f'<h1 style="text-align: center; color:#000000 ;font-size:20px;">{"Al analizar los datos sin la variable objetivo se rechaza la hipotesis nula, con un p-value menor a 0.05, se concluye que sin la variable objetivo el dataset no sigue una distribución normal multivariada."}</h1>', unsafe_allow_html=True)
